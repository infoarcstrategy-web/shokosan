...
export function getQuickAnswerData(matrixCards: (Card | null)[], userQuestion: string, readingMode: string) {
...
export function generateReadingReport(matrixCards: (Card | null)[], userQuestion: string, readingMode: string): string {
...
🔮 占卜模式：${readingMode === 'decision' ? '二選一決策模式' : readingMode === 'luck' ? '今日運勢轉運模式' : '心靈對焦模式'}
==================================================
...
==================================================
✨【時空波幅與解答總評】
verdict_tag 🌟 總評標籤：【${quickAnswer.verdictTag}】
headlineVerdict 💬 時空宣告：${quickAnswer.headlineVerdict}
